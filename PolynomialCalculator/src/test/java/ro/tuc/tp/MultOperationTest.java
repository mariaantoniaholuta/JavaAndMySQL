...
public class MultOperationTest {
    ...
    public void sumTest() {
        ...
        Monomyal m1 = new Monomyal(1,1);
        Monomyal m2 = new Monomyal(1,0);
        ...
        Monomyal m4 = new Monomyal(2,2);
        Monomyal m5 = new Monomyal(2,1);
        List<Monomyal> list3 = new ArrayList<>(Arrays.asList(m5,m4));
        ...
        String result = "";
        String finalResult = "";
        polynomial3 = Operations.multiplicate(polynomial1,polynomial2);
        ...
        assertEquals(finalResult,"2*X^2+2*X");
    }
}